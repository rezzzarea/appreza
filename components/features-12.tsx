...
export default function Features() {
    ...
    const images = {
        'item-1': {
            // image: '/charts.png',
            image: 'https://pict.sindonews.net/dyn/480/pena/news/2021/04/16/72/399570/kunci-meraih-derajat-takwa--di-bulan-ramadhan--rajin-baca-alquran-sqr.jpg',
            alt: 'Database visualization',
        },
        'item-2': {
            image: 'https://www.whyislam.org/wp-content/uploads/2025/01/Collection-of-the-Quran.jpg',
