...
function AreaForm() {
  ...
  const handleSubmit = (e:React.FormEvent)=>{
    try {
      setIsLoading(true)
      e.preventDefault() //bawaan form ketika submit form jd kosong bknnya kekirim
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-4">
      ...
      />
      <AreaButton
        type="submit" //dibuat submit krn ini form
        className="w-20 flex justify-center px-12 bg-green-500"
        disabled={isLoading}
      >
